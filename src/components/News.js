...
//       props.country
//     }&category=${props.category}&apiKey=4b6f740f1198445c9a98d6485dc8c8b1&page=${
//       page + 1
  ...
  return (
    <>
      <h1 className="text-center my-3">
        Latest Headlines of {capitalizeFirstLetter(props.category)} on
        NewsMonkey
      </h1>
      {loading && <Spinner />}
      {/* <InfiniteScroll
      ...
      <div className="container d-flex justify-content-between">
        ...
        <button disabled={page + 1 > Math.ceil(totalResults / props.pageSize)} className="btn btn-dark" onClick={handleNextClick}>
          Next &rarr;
        </button>
      </div>
    </>
